...
const MyPropertiesItem = ({slug, properties, escrow}) => {
            ...
            <div className="prop-item">
                ...
                <div className="prop-item-description">
                    <div className="d-flex justify-content-between mb-3">
                        ...
                        <span className="item-price"><i className='fab fa-ethereum' style={{ fontSize: '24px' }}></i> {Number(escrow.purchasePrice)/ 1000000000000000000}</span>
                    </div>
                    ...
                    <div className="item-icon d-flex alig-items-center justify-content-between">
                        ...
                        <Link to={{
                            ...
                            className="item-title" >
                                {
                                    Number(escrow.fundStatus) == 3 ? //full deposit
                                    (<button className="btn btn-detail">Fund Release</button>):
